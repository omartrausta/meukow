namespace meukow
{
	partial class SongView
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_listViewSong.Size = new System.Drawing.Size(260, 449);
			...
			this.m_colHeaderArtist.Text = "Artist";
			// 
			// m_colHeaderSongpath
			// 
			this.m_colHeaderSongpath.Tag = "Songpath";
			this.m_colHeaderSongpath.Text = "Songpath";
			// 
			// m_colHeaderDescription
			// 
			this.m_colHeaderDescription.Tag = "Description";
			this.m_colHeaderDescription.Text = "Description";
			// 
			// SongView
			// 
			...
			this.Name = "SongView";
			this.Size = new System.Drawing.Size(260, 449);
